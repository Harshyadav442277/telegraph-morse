...
function okRow(userHash: string): CallRow {
  return { id: Math.random().toString(36), at: new Date().toISOString(), channel: "telegram", userHash, kind: "ask", preview: "q", intent: "X", minerSlug: "m", minerId: "1", minerRank: 1, confidence: null, costUsd: 0.01, durationMs: 1, signalHash: "0x1", settlementTx: null, routedBy: null, label: null, answer: null, groupId: null, status: "ok", error: null };
}
