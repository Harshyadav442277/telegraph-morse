...
- [x] **Ask a named miner** (2026-09-04): `telegraph_ask_miner` over MCP, `{"miner": …}` on
...
- [x] **Group guard** (2026-09-04): in Telegram groups the bot answers only when @mentioned or
